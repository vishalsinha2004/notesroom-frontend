...
export default function Register({ setIsLoggedIn }) {
  ...
  return (
    // 2. Wrap the return inside a fragment so Helmet and your main div can be siblings
    <>
      {/* 3. Add the Helmet SEO data for the Register Page */}
      <Helmet>
        <title>Register | Notesroom</title>
        <meta name="description" content="Create a new Notesroom account to start uploading, organizing, and finding the coursework you need." />
      </Helmet>
