...
export default function Login({ setIsLoggedIn }) {
  ...
  return (
    // 2. Wrap your return in a fragment to keep your flex layout intact
    <>
      {/* 3. Add the Helmet SEO data for the Login Page */}
      <Helmet>
        <title>Login | Notesroom</title>
        <meta name="description" content="Sign in to your Notesroom account to securely access your documents and coursework." />
      </Helmet>
